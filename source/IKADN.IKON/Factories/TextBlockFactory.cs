...
namespace Ikadn.Ikon.Factories
{
	...
	/// </summary>
	public class TextBlockFactory : AIkonFactory
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs IKON textual object factory for text block format.
		/// </summary>
		/// <param name="registerName">Callback for registering IKADN object anchor</param>
		public TextBlockFactory(Action<string, IkadnBaseObject> registerName) : base(registerName)
		{
			//no extra operation
		}
